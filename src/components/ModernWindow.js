...
export default function ModernWindow({textSize, width, height, padding, header, output, lightMode, boldText}) {
    ...
    return (
        <div className={"modern-window " + theme} style={{width: width, height: height}}>
            ...
            <div className={"modern-content " + theme} style={{padding: padding, fontSize: textSize}}>
